...
R = 100;
L = 112.54e-3;     % Inductancia en Henrios
C = 22.5e-6;       % Capacitancia en Faradios

% Función de transferencia de un filtro pasa alto (salida en el inductor)
% H(s) = (L*s) / (L*s + R + 1/(C*s))

% Definir numerador y denominador simbólicamente
% Multiplicamos numerador y denominador por C*s para eliminar la división
...
w = logspace(0, 6, 1000); % 1 Hz a 1 MHz
s = 1j * w;
